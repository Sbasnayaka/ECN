        ...
        <div className="w-full bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="flex gap-2 text-sm text-gray-500 mb-4 font-medium items-center">
                    ...
                    <span>/</span>
                    <Link to={`/${articleInfo.category}`} className="hover:text-ecn-navy transition-colors">{articleInfo.category}</Link>
                    <span>/</span>
                    ...
                    <div className="lg:w-2/3 flex flex-col gap-6">
                            ...
                            <header className="mb-6">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-sm text-gray-500 border-t border-b border-gray-100 py-3 mt-4">
                                    <div className="flex items-center gap-4">
                                        <span className="font-bold text-ecn-navy">✍️ {articleInfo.author}</span>
                        ...
                        <div className="mt-4">
                            <h3 className="text-xl font-bold border-b-2 border-ecn-navy pb-2 mb-4">
                                <span className="bg-ecn-navy text-white px-4 py-1 inline-block">සම්බන්ධිත පුවත් (Related)</span>
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {/* Mock Related Card 1 */}
                                <div className="bg-white border border-gray-100 rounded overflow-hidden shadow-sm hover:shadow-md transition">
                                    <img src="https://via.placeholder.com/400x250/112240/ffffff?text=Related+News+1" className="w-full h-32 object-cover" alt="Related" />
                                    <div className="p-3">
                                        ...
                                        <span className="text-xs text-gray-400 mt-2 block">පැය 2කට පෙර</span>
                                    </div>
                                </div>
                                {/* Mock Related Card 2 */}
                                <div className="bg-white border border-gray-100 rounded overflow-hidden shadow-sm hover:shadow-md transition">
                                    <img src="https://via.placeholder.com/400x250/112240/ffffff?text=Related+News+2" className="w-full h-32 object-cover" alt="Related" />
                                    <div className="p-3">
                                        <h4 className="font-bold text-sm leading-snug hover:text-blue-600 cursor-pointer text-ecn-dark-blue">
                                            කොටස් වෙළෙඳපොළ මිල දර්ශක ඉහළට
                                        </h4>
                                        <span className="text-xs text-gray-400 mt-2 block">පැය 4කට පෙර</span>
                                    </div>
                                </div>
                            </div>
                        </div>
